...
from flcore.servers.serverala2 import FedALA2
from flcore.servers.serverdaa import FedDAA
...
from flcore.servers.serverpermoon import PerMOON
...
def run(args):
    ...
    for i in range(args.prev, args.times):
        ...
        elif args.algorithm == "PerMOON":
            args.head = copy.deepcopy(args.model.fc)
            args.model.fc = nn.Identity()
            args.model = BaseHeadSplit(args.model, args.head)
            server = PerMOON(args, i)
        ...
        elif args.algorithm == "FedALA2":
            server = FedALA2(args, i)

        elif args.algorithm == "FedDAA":
            server = FedDAA(args, i)
...
if __name__ == "__main__":
    ...
    # pFedMe / PerAvg / FedProx / FedAMP / FedPHP / GPFL / FedCAC /FedMOON
